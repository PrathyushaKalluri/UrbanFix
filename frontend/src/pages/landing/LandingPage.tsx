              ...
              <div className="group flex items-center gap-3 rounded-2xl border border-zinc-200/80 bg-white/90 p-2 shadow-[0_8px_32px_rgba(0,0,0,0.06)] backdrop-blur-xl transition-all duration-300 focus-within:border-emerald-300/50 focus-within:shadow-[0_8px_32px_rgba(16,185,129,0.12)]">
                ...
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    placeholder={
                      isInputFocused
                        ? "Search for services, queries, expertise..."
                        : ""
                    }
        ...
        <section id="features" className="relative px-6 py-24 lg:py-32">
          <div className="mx-auto max-w-7xl">
            ...
            >
              ...
              <h2
                className="mb-4 text-3xl font-semibold tracking-tight text-zinc-900 md:text-4xl lg:text-5xl"
                style={{ letterSpacing: "-0.02em" }}
              >
                Precision at Every Layer
              </h2>
              <p className="mx-auto max-w-xl text-lg text-zinc-500">
                Three pillars of urban orchestration, designed for maximum
                efficiency
              </p>
            </motion.div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              >
                ...
                <h2
                  className="mb-6 text-3xl font-semibold tracking-tight text-zinc-900 md:text-4xl lg:text-5xl"
                  style={{ letterSpacing: "-0.02em" }}
                >
                  Proximity Radar
                </h2>
                <p className="mb-6 text-lg leading-relaxed text-zinc-500">
                  Visualize active nodes within your immediate perimeter. Our
                  spatial awareness engine processes location data in real-time,
                  displaying available specialists as dynamic points on an
                  interactive canvas.
                </p>
        ...
        <section className="relative overflow-hidden px-6 py-24 lg:py-32">
          ...
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            >
              ...
              <h2
                className="mb-6 text-4xl font-semibold tracking-tight text-zinc-900 md:text-5xl lg:text-6xl"
                style={{ letterSpacing: "-0.02em" }}
              >
                Start Orchestrating
                <br />
